...
# source.lumisToProcess = cms.untracked.VLuminosityBlockRange('1:16-1:16')
# source.lumisToProcess = cms.untracked.VLuminosityBlockRange('1:16-1:16', '1:44-1:44')
# source.lumisToProcess = cms.untracked.VLuminosityBlockRange('1:16-1:100')
readFiles.extend( [
...
#
process.load("JetMetTesting.TrackVertexAnalyzer.TrackVertexAnalyzer_cfi")
process.TFileService = cms.Service("TFileService", fileName = cms.string("tva_tree.root") )
process.validation = cms.Sequence(
    process.tpClusterProducer *
    process.quickTrackAssociatorByHits *
    process.trackingParticleRecoTrackAsssociation *
    process.VertexAssociatorByPositionAndTracks *
    process.trackVertexAnalyzer
)
